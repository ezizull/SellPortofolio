<x-app-layout>
    <section class="flex pt-14 w-full justify-center min-h-screen bg-gray-100 space-x-4">
        ...
        @endauth
        <section id="penjual" class="flex flex-col w-auto space-y-4">
            <a id="1" href="{{ route('penjual.show', 1) }}"
                ...
                <div class="flex flex-col p-1 pr-4 w-full justify-center space-y-2">
                    ...
                    <div class="flex h-7 items-center space-x-2">
                        <p class="text-[0.8rem] font-light m-0 max-text">Lorem ipsum dolor sit, amet consectetur
                            adipisicing
                            elit. Modi consectetur cum ipsam? Possimus et rem reprehenderit beatae eveniet quo nisi
                            quae
